...
<div class="form-registro_mas">
		...
		<form method="post" action="actualizar.php">
			...
			<div class="formulario">
		        ...
		        <label>Venc. Póliza:  <input type="calendar" name="vencimiento_seguro" value="<?php echo $vencseguro_unidad?>" required=""></label>
		        <label>Propietario:   <input type="number" name="propietario" value="<?php echo $id_propietario?>" required=""></label>
		        <label>Chofer: <input type="number" name="chofer" value="<?php echo $id_chofer?>" required=""></label>
